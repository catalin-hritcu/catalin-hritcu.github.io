...
(** [list] itself is a _function_ from types to (inductively
    defined) types. *)

Check list.
(* ===> list : Type -> Type *)

(** The parameter [X] in the definition of [list] becomes
...
(** Supplying every _type argument_ is also boring, but Coq
...
(** The [filter] function -- together with some other functions
